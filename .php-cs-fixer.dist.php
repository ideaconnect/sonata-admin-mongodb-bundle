...
$rules = [
    // Migration sets matching the project's PHP 8.4 floor and PHPUnit 11/12 stack.
    // The old @PHP80Migration / @PHPUnit84Migration:risky names are deprecated
    // since php-cs-fixer 3.95 in favor of the @PHP<x>x<y>Migration form.
...
$config
    ...
    ->setRules($rules)
    ->setUsingCache(true)
    // CI runs on PHP 8.5 while the project's composer.json floor is 8.4;
    // tell php-cs-fixer that's intentional so it doesn't print the
    // unsupported-PHP-version warning on every invocation.
